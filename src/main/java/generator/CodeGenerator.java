...
//        String projectPath =rb.getString("projectPath");
        ...
        pc.setController(rb.getString("controllerModuleName"));
        pc.setService(rb.getString("serviceModuleName"));
        pc.setServiceImpl(rb.getString("serviceImplModuleName"));
        pc.setEntity(rb.getString("pojoModuleName"));
        pc.setMapper(rb.getString("mapperModuleName"));
...
//        });
        ...
        //设置实体类父类
        if (StringUtils.isNotBlank(rb.getString("superEntity"))) {
        strategy.setSuperEntityClass(rb.getString("superEntity"));
        }
